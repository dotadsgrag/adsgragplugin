...
if(!function_exists('xyz_adsg_display'))
{
	function xyz_adsg_display($atts)
	{
		...
		$adcode.='<script type="text/javascript" src="'.$path.'js/ads.js?siteId='.$row->siteid.'&position='.$a.'&adtype='.$native.'&wp=1" id="site_id_'.$id.$postion_data_para.'"></script></div>';
		}
