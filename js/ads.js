	  ...
	  jQuery.ajax({
		...
		if(position == "top"){
		   if($("header") && $("header").parent()[0])
		    ...
		    if($("header") && $("header").parent()[0])
		    {
				document.getElementById(divcontiner).appendChild(divadp);
			}
            else 
            {
		        document.body.appendChild(divadp);
		...
		//div_child[0].appendChild(h2);
		////document.getElementById('col').appendChild(h2);
		h2.innerHTML = 'Our <span>Ads</span>';
		
		title_hed = document.createElement('div');
		title_hed.className = 'titleTop';
		title_hed.id = divcontiner + 'titleTop';
		div_child[0].appendChild(title_hed);
		document.getElementById(divcontiner + 'titleTop').appendChild(h2);
		
	   divads_block = document.createElement('ul');
	   divads_block.className = 'row gridlist';
	   divads_block.id = divcontiner + 'idgridlist';
	   document.getElementById(dsf).appendChild(divads_block);
	   ...
	   document.getElementById(dsf).appendChild(divads_block);
		...
		title_hed = document.createElement('div');
		title_hed.className = 'titleTop';
		title_hed.id = ids_val + 'titleTop';
		div_child[0].appendChild(title_hed);
		document.getElementById(ids_val + 'titleTop').appendChild(h2);
		
	   divads_block = document.createElement('ul');
	   divads_block.className = 'row gridlist';
	   divads_block.id = ids_val + 'idgridlist';
	   document.getElementById(dsf).appendChild(divads_block);
...
function makePage2(ad,layout){
	...
	divcol1 = document.createElement('li');
	
	
	document.getElementById(divcontiner + 'idgridlist').appendChild(divcol1);
	if(layout == 1)
	...
	divimgclass = document.createElement('div');
	divimgclass.className = 'adimg';
	divimgclass.id = 'adimg_auto'+ divcontiner + ad[0];

	img1 = document.createElement('img');
	document.getElementById(col_ids+ad[0]).appendChild(divimgclass);
	document.getElementById('adimg_auto'+ divcontiner + ad[0]).appendChild(img1);
	...
	divtitle1.className = "innerad title_div";
	divtitle1.style.textAlign ='center';
	//divtitle1.style.margin ='10px 0';
	divtitle1.style.height ='20px';
	
	title_div_value = document.createElement('h3');
	title_div_value.id = 'title_div_auto' + divcontiner + ad[0];
	atitle1 = document.createElement('a');
	document.getElementById(title_ids+ad[0]).appendChild(title_div_value);
	document.getElementById('title_div_auto'+ divcontiner + ad[0]).appendChild(atitle1);
...
function makePage4(ad,layout){
	...
	document.getElementById(ids_val + 'idgridlist').appendChild(divcol1);
	if(layout == 1)
		divcol1.className = 'col-lg-4 col-md-4 col-sm-6 col-xs-12';
	else
		divcol1.className = 'col-sm-3';
	...
	divimgclass = document.createElement('div');
	divimgclass.className = 'adimg';
	divimgclass.id = 'adimgs+'+ ids_val + ad[0];

	img1 = document.createElement('img');
	document.getElementById(col_ids+ad[0]).appendChild(divimgclass);
	document.getElementById('adimgs+'+ ids_val + ad[0]).appendChild(img1);
	...
	title_div_value = document.createElement('h3');
	title_div_value.id = 'title_div_btm' + ad[0];
	atitle1 = document.createElement('a');
	document.getElementById(title_ids+ad[0]).appendChild(title_div_value);
	document.getElementById('title_div_btm' + ad[0]).appendChild(atitle1);
	atitle1.innerHTML = ad[6];
	atitle1.href=ad[6];
	//atitle1.target="_blank";
	atitle1.target="#";
...
function makePage(ad,layout){
	...
	divimgclass = document.createElement('div');
	divimgclass.className = 'adimg';
	divimgclass.id = 'adimgs_cat' + ids_val + ad[0];

	img1 = document.createElement('img');
	document.getElementById(col_ids+ad[0]).appendChild(divimgclass);
	document.getElementById('adimgs_cat' + ids_val + ad[0]).appendChild(img1);
...
function makePage1(ad,layout){
	...
	divimgclass = document.createElement('div');
	divimgclass.className = 'adimg';
	divimgclass.id = 'adimgtop' + ids_val + ad[0];

	img1 = document.createElement('img');
	document.getElementById(col_ids+ad[0]).appendChild(divimgclass);
	document.getElementById('adimgtop'+ ids_val + ad[0]).appendChild(img1);
